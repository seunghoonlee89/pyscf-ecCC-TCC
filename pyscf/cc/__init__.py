...
#lsh
from pyscf.cc import ecccsd_slow
...
def RCCSD(mf, frozen=None, mo_coeff=None, mo_occ=None, ecCCSD=False, ecCCSD_tmp=False, TCCSD=False, TCCSD_tmp=False, ecTCCSD=False, ecTCCSD_devel=False):
    ...
    if getattr(mf, 'with_df', None):
        ...
        return ec_ccsd.ecRCCSD(mf, frozen, mo_coeff, mo_occ)
    elif ecCCSD_tmp:
        return ec_ccsd_devel.ecRCCSD(mf, frozen, mo_coeff, mo_occ)
        #return ecccsd_slow.ecRCCSD(mf, frozen, mo_coeff, mo_occ)

    elif TCCSD:
        return rtccsd.RTCCSD(mf, frozen, mo_coeff, mo_occ)
    elif TCCSD_tmp:
        return tccsd.RTCCSD(mf, frozen, mo_coeff, mo_occ)
