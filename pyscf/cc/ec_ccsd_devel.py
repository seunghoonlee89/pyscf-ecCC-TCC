...
class ecRCCSD(ccsd.CCSD):
    ...
    def ccsd(self, coeff, t1=None, t2=None, t3aaa=None, t3aab=None, t4=None, eris=None, mbpt2=False, numzero=1E-5):
        ...
        return ccsd.CCSD.ccsd(self, t1=t1, t2=t2, eris=eris, ecCCSD_devel=True, coeff=coeff, numzero=numzero)
...
#?        assert(t2.dtype == np.double)
        return ccsd.CCSD.ccsd_t(self, t1, t2, eris, ecCCSD_devel=True, coeff=coeff)
