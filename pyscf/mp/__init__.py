...
def MP2(mf, frozen=None, mo_coeff=None, mo_occ=None, EN=False):
    ...
    if isinstance(mf, scf.uhf.UHF):
        ...
        return RMP2(mf, frozen, mo_coeff, mo_occ, EN)

def RMP2(mf, frozen=None, mo_coeff=None, mo_occ=None, EN=False):
    ...
    if getattr(mf, 'with_df', None):
        ...
        return mp2.RMP2(mf, frozen, mo_coeff, mo_occ, EN)
