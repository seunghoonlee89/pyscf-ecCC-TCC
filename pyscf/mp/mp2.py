...
def kernel(mp, mo_energy=None, mo_coeff=None, eris=None, with_t2=WITH_T2, verbose=None, EN=False):
...
class MP2(lib.StreamObject):
    ...
    def __init__(self, mf, frozen=None, mo_coeff=None, mo_occ=None, EN=False):
...
# don't modify the following attributes, they are not input options
    ...
    def kernel(self, mo_energy=None, mo_coeff=None, eris=None, with_t2=WITH_T2):
        ...
        if self._scf.converged:
            self.e_corr, self.t2 = self.init_amps(mo_energy, mo_coeff, eris, with_t2, self.EN)
        else:
    ...
    def ao2mo_en(self, mo_coeff=None):
        return _make_eris_en(self, mo_coeff, verbose=self.verbose)
    ...
    def init_amps(self, mo_energy=None, mo_coeff=None, eris=None, with_t2=WITH_T2, EN=False):
        return kernel(self, mo_energy, mo_coeff, eris, with_t2, EN=EN)
